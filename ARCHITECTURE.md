...
All arrows show static linking / dependencies (not runtime flow).
Data ownership is strictly enforced (modules own their data, eepromdata is global single source of truth).
BMSModuleManager is the ONLY component allowed to link directly to BMSModule and BMSUtil.